        ...
        <nav class="collapse navbar-collapse" role="navigation">
            <form:form modelAttribute="searchFilters" method="POST" action="${pageContext.request.contextPath}/${site}/search" class="navbar-form navbar-right" role="form">
                <div class="form-group">
                    ...
                    <form:input class="form-control" path="filter4" id="dataUscitaDa" placeholder="Data da (yyyy-mm-dd)"></form:input>
                    <form:input class="form-control" path="filter5" id="dataUscitaA" placeholder="Data a (yyyy-mm-dd)"></form:input>
                </div>
                                            ...
                                            <a href="<spring:url value="/proxy/${content.id}" />" >
                                                <c:choose>
                                                    <c:when test="${content.thumbnailId == 'default-generic'}">
                                                        <img class="img-responsive center-block" src="<spring:url value="/resource/themes/sena/icons/default-generic-icon.png" />" alt="${content.getName()}"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <img class="img-responsive center-block" src="<spring:url value="/proxy/${content.getThumbnailId()}" />" alt="${content.getName()}"/>
                                                    </c:otherwise>
                                                </c:choose>
                                            </a>
                                        </div>
