        ...
        <div class="panel panel-default">
            ...
            <nav class="panel-body">
                <ul  class="nav nav-pills nav-stacked">
                    <li role="presentation"><a href="<spring:url value="/p/${webpage.parentId}" />">
    ...
    <section class="col-sm-9">
        <div class="panel panel-default">
            <div class="panel-body">
                <c:if test="${webpage.specialContent.containsKey('text_header')}">
                    <header class="jumbotron">
                            ${webpage.specialContent.get('text_header').text}
                    </header>
                </c:if>
